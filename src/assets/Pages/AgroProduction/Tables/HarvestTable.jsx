...
const HarvestTable = ({ onCropInfo, data }) => {
  const harvestData = data.filter((item) => item.category === "harvest");
  return (
            ...
            {harvestData.map((item) => (
              <tr key={item}>
                ...
                <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-500 text-center">
                  70
                  <sup className="p-1 font-medium bg-red-100 text-red-600 rounded m-0.5">
                    90%
                  </sup>
                </td>
                <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-500 text-center">
